...
using value_type = std::variant<std::monostate, std::int32_t, std::int64_t, float, double, std::string, binary_type, date_type, time_type, timestamp_type, timetz_type, timestamptz_type, decimal_type>;
